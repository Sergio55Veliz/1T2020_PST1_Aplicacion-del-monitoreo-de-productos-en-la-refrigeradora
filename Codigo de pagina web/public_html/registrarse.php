...
<head>
    ...
    <!-- Website Title -->
    <title>Registrarse - Mi Despensa</title>
                ...
                <div class="row">
                    ...
                    <div class="form-container">
                        <form id="requestForm" data-toggle="validator" data-focus="false">
                            <div class="form-group">
                               ...
                               <div class="form-group">
                                <input type="text" class="form-control-input" id="rnamee" name="rnamee" required>
                                <label class="label-control" for="rname">Usuario</label>
                                <div class="help-block with-errors"></div>
                            </div>
                             <div class="form-group">
                                <input type="password" class="form-control-input" id="rcontraseña" name="rcontraseña" required>
                                <label class="label-control" for="rname">Contraseña</label>
                            </div>
                             <div class="form-group">
                                <input type="password" class="form-control-input" id="rcontraseña2" name="rcontraseña2" required>
                                <label class="label-control" for="rname">Reingrese contraseña</label>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="images/registro.svg" width="450" height="200">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.php">Inicio</a><i class="fa fa-angle-double-right"></i><span>Registrarse</span>
